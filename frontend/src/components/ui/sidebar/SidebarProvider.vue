...
function setOpen(value: boolean) {
  // Persistence belongs to the application preference store. The generated
  // primitive intentionally keeps this state in memory unless controlled by
  // the parent through v-model:open.
  open.value = value
}
